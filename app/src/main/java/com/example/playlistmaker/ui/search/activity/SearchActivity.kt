...
import com.example.playlistmaker.creator.StorageCreator
import com.example.playlistmaker.creator.WebCreator
import com.example.playlistmaker.domain.search.TracksInteractor
import com.example.playlistmaker.data.player.Track
import com.example.playlistmaker.domain.Resource
import com.example.playlistmaker.domain.search.TrackAdapter
import com.example.playlistmaker.domain.search.TrackHistoryAdapter
...
class SearchActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModelSearch = ViewModelProvider(this, SearchViewModel.getViewModelFactory())[SearchViewModel::class.java]
